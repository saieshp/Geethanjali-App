...
/**
 * Created by Chandu on 20-06-2017.
 */

public class Placements extends Fragment
{
    private static final String TAG = Placements.class.getSimpleName();
    ...
    {
        View rootView  = inflater.inflate(R.layout.rfs, container, false);
        ...
        AsyncTask<Integer, Void, Void> asyncTask = new AsyncTask<Integer, Void, Void>()
        {
            ...
            protected Void doInBackground(Integer... movieIds)
            {
                ...
                Request request = new Request.Builder()
                        .url("https://www.geethanjaliapps.com/app/pl.php" )
                        .build();
                try
                {
